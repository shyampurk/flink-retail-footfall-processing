...
ARG FLINK_ELASTIC_CONN_VERSION=3.0.1-1.17
...
RUN wget -P /opt/flink/lib/ https://repo.maven.apache.org/maven2/org/apache/flink/flink-json/${FLINK_VERSION}/flink-json-${FLINK_VERSION}.jar; \
    ...
    wget -P /opt/flink/lib/ https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-connector-elasticsearch7/${FLINK_ELASTIC_CONN_VERSION}/flink-sql-connector-elasticsearch7-${FLINK_ELASTIC_CONN_VERSION}.jar;
